...
This is an extension of [HyperTensioN](https://github.com/Maumagnaguagno/HyperTensioN) to work with probabilities and rewards, calls, assignments and semantic attachments, currently **incompatible** with the original.
